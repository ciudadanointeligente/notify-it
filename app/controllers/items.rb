...
post '/item/:item_type/:item_id/:email/follow' do
...
delete '/item/:item_type/:item_id/:email/unfollow' do
  #requires_login
...
helpers do
  ...
  def item_interest
    ...
    Interest.for_item present_user, item_id, item_type
  end

  def item_interest_02
    item_id = params[:item_id].strip
    item_type = params[:item_type].strip

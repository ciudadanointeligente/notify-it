# EDITS THAT CAN BE MADE TO TAGS
# SUCH AS MAKING THEM PUBLIC OR ADDING DESCRIPTION
# THE DELETING CAN COME FROM ADJUSTING THE TAGS PER SUBSCRIPTION OR FROM REMOVE SELECTED
